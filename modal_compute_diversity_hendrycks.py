...
This is the Hendrycks MATH (Qwen3-1.7B, step 400) counterpart of
modal_compute_diversity.py.

Usage:
    modal run --detach modal_compute_diversity_hendrycks.py

Reads:
    /data/pass32_1p7b_hendrycks/math_track_a_hendrycks_step400_outputs.parquet
    /data/pass32_1p7b_hendrycks/math_track_b_hendrycks_step400_outputs.parquet

Writes:
    /data/diversity_1p7b_hendrycks/embedding_diversity_results.csv
    /data/diversity_1p7b_hendrycks/embedding_diversity_summary.json
"""

import modal

app = modal.App("rlad-compute-diversity-hendrycks")
...
PASS32_DIR = "/data/pass32_1p7b_hendrycks"
OUTPUT_DIR = "/data/diversity_1p7b_hendrycks"
...
def compute_diversity():
    ...
    # 1. Load parquets
    # ------------------------------------------------------------------
    a_path = os.path.join(PASS32_DIR, "math_track_a_hendrycks_step400_outputs.parquet")
    b_path = os.path.join(PASS32_DIR, "math_track_b_hendrycks_step400_outputs.parquet")
