...
#     `DigitalLearningGmbH/MATH-lighteval` -> verl/utils/reward_score/math.py
#
# Required env vars:
...
#
# Optional:
#   WANDB_PROJECT    defaults to "rlad-hendrycks"
...
WANDB_PROJECT="${WANDB_PROJECT:-rlad-hendrycks}"
SAVE_FREQ="${SAVE_FREQ:-100}"
TEST_FREQ="${TEST_FREQ:-25}"

echo "[grpo_hendrycks_a100] TRAIN_PARQUET=$TRAIN_PARQUET"
echo "[grpo_hendrycks_a100] VAL_PARQUET=$VAL_PARQUET"
echo "[grpo_hendrycks_a100] BASE_MODEL=$BASE_MODEL"
echo "[grpo_hendrycks_a100] CKPT_DIR=$CKPT_DIR"
echo "[grpo_hendrycks_a100] EXPERIMENT_NAME=$EXPERIMENT_NAME"
echo "[grpo_hendrycks_a100] TOTAL_STEPS=$TOTAL_STEPS"
